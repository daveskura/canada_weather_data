...
stations = mydb.query("SELECT station_id,province FROM canweather.weather_station WHERE province NOT IN " + NOT_IN_PROVINCE + " ORDER BY station_id")
