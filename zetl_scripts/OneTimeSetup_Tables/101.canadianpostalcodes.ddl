...
COMMENT ON TABLE canweather.canadianpostalcodes IS 'This Postgres table was defined by schemawiz for loading the csv file zetl_scripts\OneTimeLoad_PostalCodes\CanadianPostalCodes.csv, delimiter (,)';
